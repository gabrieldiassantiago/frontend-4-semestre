      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card/90 backdrop-blur">
        <div className="mx-auto flex h-16 w-full max-w-[1280px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <Badge variant="success" size="sm" className="hidden uppercase tracking-wide xl:inline-flex">
              Empresas
            </Badge>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="hidden items-center gap-1.5 whitespace-nowrap rounded-lg bg-primary px-3.5 py-2 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary-hover xl:inline-flex"
            >
